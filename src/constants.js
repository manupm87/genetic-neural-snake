...
export const KIND_FOOD = 0
export const KIND_WALL = 1
export const KIND_SELF = 2

export const CONN_FULLY_CONNECTED = 0
export const AF_SIGMOID = 0
export const AF_RELU = 1
export const AF_TANH = 2

export const TYPE_INPUT = 0
export const TYPE_HIDDEN = 1
